...
import{r as p,j as n,C as K,_ as pe,B as Ne,S as qe,M as Te,R as De,a as Re}from"./vendor-react-BMF5l2ym.js";import{B as Ce,p as Me}from"./vendor-utils-DahDrsZr.js";import{r as je}from"./vendor-katex-CiiTTpw-.js";import"./vendor-B3CQIlJd.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const d of o)if(d.type==="childList")for(const r of d.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(o){const d={};return o.integrity&&(d.integrity=o.integrity),o.referrerPolicy&&(d.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?d.credentials="include":o.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function i(o){if(o.ep)return;o.ep=!0;const d=t(o);fetch(o.href,d)}})();function Ae({chapters:a,currentChapter:e,bodyContent:t,onChapterSelect:i,currentScript:o,onScriptSelect:d,selectedTopicId:r,onTopicSelect:f,loading:v}){var b,w;const l=p.useMemo(()=>{const s=e==null?void 0:e.content;if(!s)return[];let m="";const _=s.intro;typeof _=="string"?m=_:_&&typeof _=="object"&&_.body&&(m+=typeof _.body=="string"?_.body:Object.values(_.body).join(`
`));const y=t||s.body;if(y&&(typeof y=="string"?m+=`
`+y:Array.isArray(y)?m+=`
`+y.join(`
`):typeof y=="object"&&(m+=`
`+Object.values(y).join(`
`))),!m)return[];const N=/^###\s+(.+)$/gm,R=[];let A;for(;(A=N.exec(m))!==null;){const M=A[1].trim(),$="topic-"+M.replace(/\s+/g,"-").toLowerCase();R.push({id:$,title:M})}return R},[e,t]);return n.jsxs("div",{className:"top-nav-container",children:[n.jsx("div",{className:"nav-group",children:n.jsxs("div",{className:"custom-select-wrapper",children:[n.jsxs("select",{id:"chapter-select",name:"chapter-select",value:(e==null?void 0:e.id)||"",onChange:s=>{const m=a.find(_=>_.id===s.target.value);m&&i(m)},disabled:v||a.length===0,className:"custom-select",children:[n.jsx("option",{value:"",disabled:!0,children:v?"載入中...":"📖 章節選擇"}),a.map(s=>n.jsx("option",{value:s.id,children:s.title},s.id))]}),n.jsx(K,{className:"select-icon",size:16})]})}),n.jsx("div",{className:`nav-group ${!e||l.length===0?"disabled":""}`,children:n.jsxs("div",{className:"custom-select-wrapper",children:[n.jsxs("select",{id:"topic-select",name:"topic-select",value:r,onChange:s=>f(s.target.value),disabled:!e||l.length===0,className:"custom-select",children:[n.jsx("option",{value:"",children:"💡 重點導覽"}),l.map(s=>n.jsx("option",{value:s.id,children:s.title},s.id))]}),n.jsx(K,{className:"select-icon",size:16})]})}),n.jsx("div",{className:`nav-group ${e?"":"disabled"}`,children:n.jsxs("div",{className:"custom-select-wrapper",children:[n.jsxs("select",{id:"script-select",name:"script-select",value:(o==null?void 0:o.filename)||"",onChange:s=>{var _;const m=(e==null?void 0:e.examples)||((_=e==null?void 0:e.content)==null?void 0:_.examples);if(m){const y=m.find(N=>N.filename===s.target.value);y&&d(y)}},disabled:!e||!(e.examples||(b=e.content)!=null&&b.examples)||(e.examples||((w=e.content)==null?void 0:w.examples)||[]).length===0,className:"custom-select",children:[n.jsx("option",{value:"",disabled:!0,children:"💻 程式代碼"}),(()=>{var _;return[...(e==null?void 0:e.examples)||((_=e==null?void 0:e.content)==null?void 0:_.examples)||[]].sort((y,N)=>y.filename.localeCompare(N.filename,void 0,{numeric:!0,sensitivity:"base"})).map(y=>n.jsx("option",{value:y.filename,children:y.filename},y.filename))})()]}),n.jsx(K,{className:"select-icon",size:16})]})})]})}const Be=new Ce,Ie=p.memo(({chapter:a,bodyContent:e,onCodeClick:t,selectedTopicId:i,output:o,isRunning:d,plotImages:r})=>{const f=p.useRef(null),v=p.useMemo(()=>{var b,w;if(!a)return null;const l=(b=a.content)==null?void 0:b.intro;if(l){let s="";if(typeof l=="string")s=l;else if(typeof l=="object"){s=`# ${l.title||""}
...
`);const m=[];s=s.replace(/\$\$([\s\S]*?)\$\$/g,(x,h)=>{const q=m.length;return m.push({type:"display",content:h}),` @@MATH_BLOCK_${q}@@ `}),s=s.replace(/\\begin\{aligned\}([\s\S]*?)\\end\{aligned\}/g,(x,h)=>{const q=m.length;return m.push({type:"display",content:`\\begin{aligned}${h}\\end{aligned}`}),` @@MATH_BLOCK_${q}@@ `}),s=s.replace(new RegExp("(?<!\\\\)\\$([^$\\n]+?)\\$","g"),(x,h)=>{const q=m.length;return m.push({type:"inline",content:h}),` @@MATH_BLOCK_${q}@@ `});let y=Be.parse(s).replace(/<h3>(.*?)<\/h3>/g,(x,h)=>`<h3 id="${"topic-"+h.replace(/<[^>]*>/g,"").trim().replace(/\s+/g,"-").toLowerCase()}">${h}</h3>`);const N=Me.sanitize(y,{USE_PROFILES:{html:!0,mathml:!0},ADD_TAGS:["math","annotation","semantics","mrow","msub","msup","msubsup","mover","munder","munderover","mmultiscripts","mprec","mnext","mtable","mtr","mtd","mfrac","msqrt","mroot","mstyle","merror","mpadded","mphantom","mfenced","menclose","ms","mglyph","maligngroup","malignmark","maction","svg","path","use","span","div"],ADD_ATTR:["id","target","xlink:href","class","style","aria-hidden","viewBox","d","fill","stroke","stroke-width","data-filename","encoding","display"]}),A=[...a.examples||[]].sort((x,h)=>h.filename.length-x.filename.length);let M=N;return A.forEach(x=>{const h=x.filename.replace(".","\\."),q=new RegExp(`(?<!['".\\w])(${h})(?!['".\\w])`,"g");M=M.replace(q,`<span class="code-link" data-filename="${x.filename}">${x.filename}</span>`)}),M.replace(/@@MATH_BLOCK_(\d+)@@/g,(x,h)=>{const q=m[parseInt(h)];return q.type==="display"?`\\[ ${q.content.trim()} \\]`:`\\( ${q.content.trim()} \\)`})}else{const s=a.examples||[];let m=`
