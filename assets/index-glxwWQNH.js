const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CodePreviewPanel-B1gAKygg.js","assets/vendor-react-BScQi9YO.js","assets/vendor-B3CQIlJd.js","assets/CodePreviewPanel-CL3Tw202.css"])))=>i.map(i=>d[i]);
import{r as p,j as n,C as K,_ as pe,B as Le,S as Te,M as Ne,R as Re,a as Ce}from"./vendor-react-BScQi9YO.js";import{B as De,p as qe}from"./vendor-utils-DahDrsZr.js";import{r as Me}from"./vendor-katex-BZbyxtyH.js";import"./vendor-B3CQIlJd.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const c of o)if(c.type==="childList")for(const r of c.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(o){const c={};return o.integrity&&(c.integrity=o.integrity),o.referrerPolicy&&(c.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?c.credentials="include":o.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function i(o){if(o.ep)return;o.ep=!0;const c=t(o);fetch(o.href,c)}})();function je({chapters:a,currentChapter:e,bodyContent:t,onChapterSelect:i,currentScript:o,onScriptSelect:c,selectedTopicId:r,onTopicSelect:f,loading:v}){var b,w;const l=p.useMemo(()=>{const s=e==null?void 0:e.content;if(!s)return[];let m="";const u=s.intro;typeof u=="string"?m=u:u&&typeof u=="object"&&u.body&&(m+=typeof u.body=="string"?u.body:Object.values(u.body).join(`
`));const y=t||s.body;if(y&&(typeof y=="string"?m+=`
`+y:Array.isArray(y)?m+=`
`+y.join(`
`):typeof y=="object"&&(m+=`
`+Object.values(y).join(`
`))),!m)return[];const R=/^###\s+(.+)$/gm,D=[];let B;for(;(B=R.exec(m))!==null;){const M=B[1].trim(),$="topic-"+M.replace(/\s+/g,"-").toLowerCase();D.push({id:$,title:M})}return D},[e,t]);return n.jsxs("div",{className:"top-nav-container",children:[n.jsx("div",{className:"nav-group",children:n.jsxs("div",{className:"custom-select-wrapper",children:[n.jsxs("select",{id:"chapter-select",name:"chapter-select",value:(e==null?void 0:e.id)||"",onChange:s=>{const m=a.find(u=>u.id===s.target.value);m&&i(m)},disabled:v||a.length===0,className:"custom-select",children:[n.jsx("option",{value:"",disabled:!0,children:v?"載入中...":"📖 章節選擇"}),a.map(s=>n.jsx("option",{value:s.id,children:s.title},s.id))]}),n.jsx(K,{className:"select-icon",size:16})]})}),n.jsx("div",{className:`nav-group ${!e||l.length===0?"disabled":""}`,children:n.jsxs("div",{className:"custom-select-wrapper",children:[n.jsxs("select",{id:"topic-select",name:"topic-select",value:r,onChange:s=>f(s.target.value),disabled:!e||l.length===0,className:"custom-select",children:[n.jsx("option",{value:"",children:"💡 重點導覽"}),l.map(s=>n.jsx("option",{value:s.id,children:s.title},s.id))]}),n.jsx(K,{className:"select-icon",size:16})]})}),n.jsx("div",{className:`nav-group ${e?"":"disabled"}`,children:n.jsxs("div",{className:"custom-select-wrapper",children:[n.jsxs("select",{id:"script-select",name:"script-select",value:(o==null?void 0:o.filename)||"",onChange:s=>{var u;const m=(e==null?void 0:e.examples)||((u=e==null?void 0:e.content)==null?void 0:u.examples);if(m){const y=m.find(R=>R.filename===s.target.value);y&&c(y)}},disabled:!e||!(e.examples||(b=e.content)!=null&&b.examples)||(e.examples||((w=e.content)==null?void 0:w.examples)||[]).length===0,className:"custom-select",children:[n.jsx("option",{value:"",disabled:!0,children:"💻 程式代碼"}),(()=>{var u;return[...(e==null?void 0:e.examples)||((u=e==null?void 0:e.content)==null?void 0:u.examples)||[]].sort((y,R)=>y.filename.localeCompare(R.filename,void 0,{numeric:!0,sensitivity:"base"})).map(y=>n.jsx("option",{value:y.filename,children:y.filename},y.filename))})()]}),n.jsx(K,{className:"select-icon",size:16})]})})]})}const Be=new De,Ae=p.memo(({chapter:a,bodyContent:e,onCodeClick:t,selectedTopicId:i,output:o,isRunning:c,plotImages:r})=>{const f=p.useRef(null),v=p.useMemo(()=>{var b,w;if(!a)return null;const l=(b=a.content)==null?void 0:b.intro;if(l){let s="";if(typeof l=="string")s=l;else if(typeof l=="object"){s=`# ${l.title||""}
...
`);const m=[];s=s.replace(/\$\$([\s\S]*?)\$\$/g,(x,h)=>{const T=m.length;return m.push({type:"display",content:h}),` @@MATH_BLOCK_${T}@@ `}),s=s.replace(/\\begin\{aligned\}([\s\S]*?)\\end\{aligned\}/g,(x,h)=>{const T=m.length;return m.push({type:"display",content:`\\begin{aligned}${h}\\end{aligned}`}),` @@MATH_BLOCK_${T}@@ `}),s=s.replace(new RegExp("(?<!\\\\)\\$([^$\\n]+?)\\$","g"),(x,h)=>{const T=m.length;return m.push({type:"inline",content:h}),` @@MATH_BLOCK_${T}@@ `});let y=Be.parse(s).replace(/<h3>(.*?)<\/h3>/g,(x,h)=>`<h3 id="${"topic-"+h.replace(/<[^>]*>/g,"").trim().replace(/\s+/g,"-").toLowerCase()}">${h}</h3>`);const R=qe.sanitize(y,{USE_PROFILES:{html:!0,mathml:!0},ADD_TAGS:["math","annotation","semantics","mrow","msub","msup","msubsup","mover","munder","munderover","mmultiscripts","mprec","mnext","mtable","mtr","mtd","mfrac","msqrt","mroot","mstyle","merror","mpadded","mphantom","mfenced","menclose","ms","mglyph","maligngroup","malignmark","maction","svg","path","use","span","div"],ADD_ATTR:["id","target","xlink:href","class","style","aria-hidden","viewBox","d","fill","stroke","stroke-width","data-filename","encoding","display"]}),B=[...a.examples||[]].sort((x,h)=>h.filename.length-x.filename.length);let M=R;return B.forEach(x=>{const h=x.filename.replace(".","\\."),T=new RegExp(`(?<!['".\\w])(${h})(?!['".\\w])`,"g");M=M.replace(T,`<span class="code-link" data-filename="${x.filename}">${x.filename}</span>`)}),M.replace(/@@MATH_BLOCK_(\d+)@@/g,(x,h)=>{const T=m[parseInt(h)];return T.type==="display"?`\\[ ${T.content.trim()} \\]`:`\\( ${T.content.trim()} \\)`})}else{const s=a.examples||[];let m=`
        <div class="chapter-intro">
          <h2>${a.title}</h2>
          <p>本章包含 ${s.length} 個程式範例</p>
          <div class="example-grid">
      `;return s.forEach((u,y)=>{m+=`
...
builtins.input = custom_input
            `),await e.yieldToUI();const c=async(r,f,{timeoutMs:v=15e3,required:l=!1}={})=>{try{await _e(t,r,v)}catch(b){if(console.warn(`[Pyodide] Shim failed: ${f}`,b),l)throw b}await e.yieldToUI()};return await c(Ve,"BASE_ENV_SETUP",{timeoutMs:2e4,required:!0}),e.update(92,"核心：正在注入資料集路徑重導向..."),await c(Ge,"DATASET_SHIM",{timeoutMs:15e3,required:!0}),e.update(94,"核心：正在注入常用模組 stub..."),await c(We,"SCIPY_STUB",{timeoutMs:15e3}),await c(Ke,"ARCH_STUB",{timeoutMs:15e3}),await c(Ye,"MIBIAN_STUB",{timeoutMs:15e3}),await c(ue,"MCINT_SHIM",{timeoutMs:15e3}),Y=t,F=null,e.finish("基礎核心載入完成！"),t}catch(t){throw F=null,e.interval&&clearInterval(e.interval),console.error("Failed to load Pyodide:",t),t}})(),F)}let oe=!1,O=null;async function tt(a){return oe||O||(O=(async()=>{try{const e=["scipy","statsmodels","scikit-learn"];for(const o of e)await a.loadPackage(o);const t=["seaborn","numpy-financial","pandas-datareader","pyodide-http","chart_studio","plotly","prettytable","qpsolvers","tabulate"],i=a.pyimport("micropip");for(const o of t)try{await i.install(o)}catch(c){console.warn(`[Background] Failed to preload ${o}:`,c)}await Promise.all([a.runPythonAsync(He),a.runPythonAsync(Ue),a.runPythonAsync(me),a.runPythonAsync(ue)]),oe=!0}catch(e){console.error("⚠️ [Background] Heavy package preload failed:",e),O=null}})()),O}async function _e(a,e,t=3e4){let i;const o=new Promise((c,r)=>{i=setTimeout(()=>{r(new Error(`Execution timed out after ${t/1e3} seconds`))},t)});try{return await Promise.race([a.runPythonAsync(e),o])}finally{clearTimeout(i)}}async function at(a){if(a)try{await a.runPythonAsync(`
import gc
import matplotlib.pyplot as plt
plt.close('all')
gc.collect()
        `)}catch{}}async function st(a){try{const e=await a.runPythonAsync(`
import matplotlib.pyplot as plt
len(plt.get_fignums())
...
if plt.style.available and 'default' in plt.style.available:
    ...
    `)}catch(t){console.error("✗ Matplotlib 初始化失敗:",t)}}async function rt(a){try{await a.runPythonAsync(`
import matplotlib.pyplot as plt
...
${e}`}class nt{constructor(){this.metrics={},this.enabled=!0}start(e){this.enabled&&(this.metrics[e]={start:performance.now(),end:null,duration:null})}end(e){if(!this.enabled||!this.metrics[e])return 0;const t=performance.now(),i=this.metrics[e].start,o=t-i;return this.metrics[e].end=t,this.metrics[e].duration=o,this.log(e,o),o}log(e,t){const i=t<100?"⚡":t<1e3?"⏱️":"🐌",o=t<100?"color: green":t<1e3?"color: orange":"color: red";console.debug(`%c${i} ${e}: ${t.toFixed(2)}ms`,o),t>3e3&&console.warn(`⚠️ ${e} 執行時間過長: ${t.toFixed(2)}ms`)}async measure(e,t){this.start(e);try{return await t()}finally{this.end(e)}}getMetric(e){return this.metrics[e]||null}getMetrics(){return{...this.metrics}}getStats(){const e=Object.values(this.metrics).filter(t=>t.duration!==null).map(t=>t.duration);return e.length===0?{count:0,total:0,average:0,min:0,max:0}:{count:e.length,total:e.reduce((t,i)=>t+i,0),average:e.reduce((t,i)=>t+i,0)/e.length,min:Math.min(...e),max:Math.max(...e)}}clear(e){e?delete this.metrics[e]:this.metrics={}}setEnabled(e){this.enabled=e}report(){const e=this.getStats();console.group("📊 效能報告"),console.warn(`總計測量: ${e.count} 次`),console.warn(`總時間: ${e.total.toFixed(2)}ms`),console.warn(`平均時間: ${e.average.toFixed(2)}ms`),console.warn(`最快: ${e.min.toFixed(2)}ms`),console.warn(`最慢: ${e.max.toFixed(2)}ms`),console.groupEnd(),console.group("📋 詳細指標"),Object.entries(this.metrics).forEach(([t,i])=>{i.duration!==null&&console.warn(`${t}: ${i.duration.toFixed(2)}ms`)}),console.groupEnd()}}const I=new nt;I.setEnabled(!1);let de=!1;function it(){if(!de&&I.enabled&&(de=!0,"PerformanceObserver"in window)){new PerformanceObserver(o=>{const c=o.getEntries(),r=c[c.length-1];console.debug("🎨 LCP:",r.renderTime||r.loadTime)}).observe({entryTypes:["largest-contentful-paint"]}),new PerformanceObserver(o=>{o.getEntries().forEach(r=>{console.debug("⚡ FID:",r.processingStart-r.startTime)})}).observe({entryTypes:["first-input"]});let t=0;new PerformanceObserver(o=>{o.getEntries().forEach(r=>{r.hadRecentInput||(t+=r.value)}),console.debug("📐 CLS:",t)}).observe({entryTypes:["layout-shift"]})}}const ot=p.lazy(()=>pe(()=>import("./CodePreviewPanel-B1gAKygg.js"),__vite__mapDeps([0,1,2,3]))),J={QuantLib:"QuantLib",arch:"arch",autograd:"autograd",chart_studio:"chart-studio",datetime:"datetime",lxml:"lxml",math:"math",matplotlib:"matplotlib",mcint:"mcint",mibian:"mibian",mpl_toolkits:"matplotlib",numpy:"numpy",numpy_financial:"wheels/numpy_financial-1.0.0-py3-none-any.whl",openpyxl:"openpyxl",pandas:"pandas",pandas_datareader:"wheels/pandas_datareader-0.10.0-py3-none-any.whl",plotly:"plotly",prettytable:"prettytable",pylab:"matplotlib",pymoo:"wheels/pymoo-0.4.1-py3-none-any.whl",pyodide_http:"wheels/pyodide_http-0.2.2-py3-none-any.whl",qpsolvers:"qpsolvers",requests:"requests","scikit-learn":"scikit-learn",scipy:"scipy",seaborn:"wheels/seaborn-0.13.2-py3-none-any.whl",sklearn:"scikit-learn",statsmodels:"statsmodels",sympy:"sympy",tabulate:"tabulate"},fe={requests:["certifi","charset_normalizer","idna","urllib3"],certifi:"wheels/certifi-2026.1.4-py3-none-any.whl",charset_normalizer:"wheels/charset_normalizer-3.4.4-py3-none-any.whl",idna:"wheels/idna-3.11-py3-none-any.whl",urllib3:"wheels/urllib3-2.6.3-py3-none-any.whl"};typeof window<"u"&&"serviceWorker"in navigator&&(async()=>{try{const a=`/pwa_FRM_Book2_python/assets-manifest.json?t=${Date.now()}`,e=`/pwa_FRM_Book2_python/manifest.webmanifest?t=${Date.now()}`;let t=null;try{const r=await fetch(a,{cache:"no-store"});r&&r.ok&&(t=await r.text())}catch{}if(!t)try{const r=await fetch(e,{cache:"no-store"});if(!r||!r.ok)return;t=await r.text()}catch{return}const i=localStorage.getItem("app_assets_manifest_text");if(i&&i===t)return;localStorage.setItem("app_assets_manifest_text",t);const o=await navigator.serviceWorker.getRegistrations();if(!o||o.length===0){localStorage.getItem("app_manifest_reload_done")||(localStorage.setItem("app_manifest_reload_done","1"),location.reload());return}for(const r of o)try{await r.update(),r.waiting&&r.waiting.postMessage({type:"SKIP_WAITING"})}catch(f){console.warn("SW update attempt failed:",f)}const c=()=>{localStorage.getItem("app_manifest_reload_done")||(localStorage.setItem("app_manifest_reload_done","1"),window.location.reload())};navigator.serviceWorker.addEventListener("controllerchange",c)}catch(a){console.warn("Version check/update failed:",a)}})();function lt(){const[a,e]=p.useState(null),[t,i]=p.useState(!0),[o,c]=p.useState(0),[r,f]=p.useState("初始化中..."),[v,l]=p.useState([]),[b,w]=p.useState(!0),[s,m]=p.useState(null),[u,y]=p.useState(null),[R,D]=p.useState(""),[B,M]=p.useState({}),{bodyContent:$}=Oe(s),[x,h]=p.useState(""),[T,j]=p.useState([]),[H,W]=p.useState(!1),[X,he]=p.useState(!1),[q,ge]=p.useState(()=>{const _=localStorage.getItem("theme");return _==="dark"||!_&&!1}),[Z,ye]=p.useState(600),[A]=p.useState(new Set),[ee,te]=p.useState(null),ae=p.useRef(!1);p.useEffect(()=>{w(!0);const _=`/pwa_FRM_Book2_python/data/chapters_index.json?t=${Date.now()}`;fetch(_).then(d=>d.json()).then(d=>{d&&d.length>0&&l(d),w(!1)}).catch(d=>{console.error("Failed to load chapters index:",d),w(!1)})},[]);const ve=async _=>{if(B[_])return B[_];try{w(!0);const d=await fetch(`/pwa_FRM_Book2_python/data/chapters_${_}.json?t=${Date.now()}`);if(!d.ok)throw new Error(`HTTP error! status: ${d.status}`);const S=await d.text();let P=null;try{P=JSON.parse(S)}catch{try{const E=S.replace(/\\(?!["\\/bfnrtu])/g,"\\\\");P=JSON.parse(E)}catch(E){throw new Error(`Failed to parse chapter data: ${E.message}`)}}return M(E=>({...E,[_]:P})),w(!1),P}catch(d){return console.error(`Failed to load chapter ${_}:`,d),w(!1),null}};p.useEffect(()=>{et((d,S)=>{c(d),f(S)}).then(d=>{e(d),i(!1),I.end("pyodide-init")}),it();const _=[];if("serviceWorker"in navigator){const d=setInterval(()=>{navigator.serviceWorker.getRegistrations().then(P=>{P.forEach(E=>E.update())})},36e5),S=()=>{};navigator.serviceWorker.addEventListener("controllerchange",S),_.push(()=>{clearInterval(d),navigator.serviceWorker.removeEventListener("controllerchange",S)})}if("storage"in navigator&&"estimate"in navigator.storage){const d=async()=>{try{const P=await navigator.storage.estimate();P.usage&&P.quota&&P.usage/P.quota*100>80&&console.warn("Storage usage is high (>80%). Consider cleaning up.")}catch(P){console.warn("Failed to check storage quota:",P)}};d();const S=setInterval(d,300*1e3);_.push(()=>clearInterval(S))}return()=>{_.forEach(d=>d())}},[]),p.useEffect(()=>{a&&!t&&tt(a).then(()=>{ae.current||(ae.current=!0,console.warn("Background initialization complete"))}).catch(_=>console.error("Background loaded failed",_))},[a,t]),p.useEffect(()=>{localStorage.setItem("theme",q?"dark":"light"),document.documentElement.setAttribute("data-theme",q?"dark":"light")},[q]);const se=async(_,d=!1)=>{var ne;if(!a)return;const S=_.match(/^\s*(?:from|import)\s+([a-zA-Z0-9_]+)/gm);if(!S)return;if(/^\s*(?:from|import)\s+QuantLib\b/m.test(_)&&!A.has("QuantLib"))try{d||h(g=>g+`正在啟用 QuantLib 相容性墊片...
`),await a.runPythonAsync(ze),A.add("QuantLib"),d||h(g=>g+`✅ QuantLib 墊片已啟用。
`)}catch(g){console.warn("QuantLib shim injection failed:",g),d||h(k=>k+`⚠️ QuantLib 墊片啟用失敗，將嘗試繼續執行...
`)}const P=["sys","os","io","time","timeit","base64","json","datetime","math","re","warnings","builtins","types","random","csv","copy","collections","itertools","functools","pathlib","fractions","struct","operator","string","decimal","abc","enum","typing","textwrap"],E=["numpy","pandas","matplotlib","micropip","js","builtins","QuantLib","mcint","arch","mibian"],C=[...new Set(S.map(g=>{const k=g.trim().split(/\s+/);return k[0]==="from",k[1].split(".")[0]}))].filter(g=>!P.includes(g)&&!E.includes(g)).filter(g=>{var k;return!A.has(g)&&!((k=window.failedPackages)!=null&&k.has(g))});if(C.length===0)return;const Q=[],z=[],V=new URL("/pwa_FRM_Book2_python/",window.location.origin).href,Ee=new Set(["scipy","statsmodels","scikit-learn","sympy"]),U=g=>{if(g){if(typeof g=="string"&&(g.endsWith(".whl")||g.startsWith("http"))){z.push(g);return}Ee.has(g)?Q.push(g):z.push(g)}},re={sklearn:["scipy","scikit-learn"],"scikit-learn":["scipy"],statsmodels:["scipy"],sympy:[],seaborn:["matplotlib","pandas","scipy","statsmodels"],pandas_datareader:["requests"]};if(C.forEach(g=>{const k=J[g];k?(U(k.endsWith(".whl")?V+k:k),(fe[g]||[]).forEach(N=>{const G=fe[N]||N;U(G.endsWith(".whl")?V+G:G)})):U(g),re[g]&&re[g].forEach(L=>{if(!A.has(L)&&!E.includes(L)){const N=J[L]||L;U(N.endsWith(".whl")?V+N:N)}})}),Q.length>0||z.length>0)try{const g=[...new Set(Q)],k=[...new Set(z)];d||h(L=>L+`正在動態載入所需套件 [${C.join(", ")}]...
`);for(const L of g)await a.loadPackage(L);k.length>0&&(await a.loadPackage("micropip"),await a.runPythonAsync(`
import micropip
await micropip.install(${JSON.stringify(k)}, keep_going=True)
        `)),C.includes("pandas_datareader")&&await a.runPythonAsync(me),C.includes("matplotlib")&&(await le(a),ee||te("AGG")),C.forEach(L=>{A.add(L);const N=J[L];N&&!N.endsWith(".whl")&&A.add(N)}),d||h(L=>L+`✅ 套件載入完成。
`)}catch(g){if(console.warn("Dependency loading failed:",g),window.failedPackages||(window.failedPackages=new Set),C.forEach(k=>window.failedPackages.add(k)),!d){const k=g.message||String(g);if(k.includes("Can't find a pure Python 3 wheel")){const L=((ne=k.match(/for: '([^']+)'/))==null?void 0:ne[1])||"unknown";h(N=>N+`⚠️ 套件 "${L}" 無法載入（可能不支援瀏覽器環境），嘗試繼續執行...
`)}else h(L=>L+`⚠️ 套件載入出現問題，嘗試直接執行...
`)}}},we=async _=>{if(!(!a||H||!_)){W(!0),h(`執行中...
`),j([]);try{try{_=_.replace(/pd\.read_csv\(r?['"][^'"]*SPX_Option\.csv['"]\)/g,"pd.read_csv('/data/datasets/b2_ch1/SPX_Option.csv')")}catch{}s&&s.id&&await ie(a,s.id),await se(_),I.start("run-code"),await at(a);const d=_.includes("matplotlib.widgets")||_.includes("Slider")||_.includes("Button");he(d);const S=d?"module://matplotlib_pyodide.wasm_backend":"AGG";if(ee!==S&&(await le(a,d),te(S)),await a.runPythonAsync(`
import sys
from io import StringIO
sys.stdout = StringIO()
      `),d){const E=document.getElementById("pyodide-plot-container");E&&(E.innerHTML="",window.document.pyodideMplTarget=E)}try{await _e(a,_)}catch(E){const C=await a.runPythonAsync("sys.stdout.getvalue()"),Q=ce(E);h((C?C+`
`:"")+Q),W(!1),I.end("run-code");return}const P=await a.runPythonAsync("sys.stdout.getvalue()");if(h(P||"執行完成（無文字內容輸出 ）"),X)await rt(a);else{const E=await st(a);j(E)}}catch(d){const S=ce(d);h(S),console.error(d)}finally{W(!1),I.end("run-code")}}},be=async _=>{let d=_;if(_&&!_.content&&(d=await ve(_.id)),!!d&&(m(d),y(null),D(""),h(""),j([]),d&&d.examples&&a)){const S=d.examples.map(P=>P.code).join(`
`);se(S,!0)}};p.useEffect(()=>{a&&s&&s.id&&ie(a,s.id).catch(_=>console.error("Dataset lazy load failed",_))},[a,s]);const xe=_=>{y(_),h(""),j([])},ke=_=>{y(_),h(""),j([])},Se=()=>{y(null),h(""),j([])},Pe=t;return n.jsxs("div",{className:`app ${q?"dark":""}`,children:[n.jsxs("div",{className:"main-content",children:[n.jsxs("div",{className:"top-bar",children:[n.jsxs("div",{className:"top-bar-left",children:[n.jsx(Le,{size:20,className:"logo-icon"}),n.jsx("span",{className:"app-title",children:"FRM_Book2 (實戰篇)"})]}),n.jsx(je,{chapters:v,currentChapter:s,bodyContent:$,onChapterSelect:be,currentScript:u,onScriptSelect:ke,selectedTopicId:R,onTopicSelect:D,loading:b}),n.jsx("div",{className:"top-bar-right",children:n.jsx("button",{className:"theme-toggle",onClick:()=>ge(!q),title:q?"切換到亮色模式":"切換到暗色模式",children:q?n.jsx(Te,{size:20}):n.jsx(Ne,{size:20})})})]}),Pe&&n.jsx("div",{className:"hydration-overlay",children:n.jsxs("div",{className:"hydration-card",children:[n.jsxs("div",{className:"hydration-header",children:[n.jsx("div",{className:"hydration-title",children:"FRM Python 引擎啟動中"}),n.jsx("div",{className:"hydration-subtitle",children:"Financial Risk Management"})]}),n.jsx("div",{className:"hydration-progress-container",children:n.jsx("div",{className:"hydration-progress-bar",style:{width:`${o}%`}})}),n.jsxs("div",{className:"hydration-status",children:[n.jsx("span",{children:r}),n.jsxs("span",{children:[o,"%"]})]})]})}),n.jsxs("div",{className:"panes-container",children:[n.jsx("div",{className:"content-pane",children:n.jsx(Ae,{chapter:s,bodyContent:$,onCodeClick:xe,selectedTopicId:R,darkMode:q,output:x,isRunning:H,plotImages:T,onClearOutput:()=>{h(""),j([])}})}),u&&n.jsx("div",{className:"preview-pane",style:{width:`${Z}px`},children:n.jsx(p.Suspense,{fallback:n.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",height:"100%",color:"#888"},children:"Loading Editor..."}),children:n.jsx(ot,{script:u,onClose:Se,onRun:we,isRunning:H,isLoading:t,output:x,images:T,isInteractive:X,darkMode:q,width:Z,onResize:ye})})})]})]}),n.jsx(Fe,{pyodide:a}),n.jsx(Qe,{})]})}async function ct(){try{if(!("serviceWorker"in navigator))return;const a="frm_sw_cleanup_done_v3";if(localStorage.getItem(a))return;if(!navigator.serviceWorker.controller){localStorage.setItem(a,"1");return}console.warn("[AUTO-CLEAN] STALE SERVICE WORKER DETECTED! Starting emergency cleanup.");try{const e=await navigator.serviceWorker.getRegistrations();await Promise.all(e.map(t=>(console.warn("[AUTO-CLEAN] Unregistering:",t.scope),t.unregister().catch(()=>{})))),console.warn("[AUTO-CLEAN] serviceWorker registrations unregistered.")}catch(e){console.warn("[AUTO-CLEAN] Failed to unregister service workers",e)}try{if("caches"in window){const e=await caches.keys();await Promise.all(e.map(t=>(console.warn("[AUTO-CLEAN] Deleting Cache:",t),caches.delete(t).catch(()=>{})))),console.warn("[AUTO-CLEAN] CacheStorage cleared:",e)}}catch(e){console.warn("[AUTO-CLEAN] Failed to clear CacheStorage",e)}try{if("databases"in indexedDB){const e=await indexedDB.databases();await Promise.all(e.map(t=>indexedDB.deleteDatabase(t.name).catch(()=>{}))),console.warn("[AUTO-CLEAN] IndexedDB databases deleted:",e.map(t=>t.name))}else{const e=["pyodide","emscripten-archives","idb-filesystem","file_storage","workbox-precache-v2"];await Promise.all(e.map(t=>indexedDB.deleteDatabase(t).catch(()=>{}))),console.warn("[AUTO-CLEAN] IndexedDB fallback delete attempted for candidates.")}}catch(e){console.warn("[AUTO-CLEAN] Failed to clear IndexedDB",e)}try{const e=localStorage.getItem("theme");localStorage.clear(),sessionStorage.clear(),e&&localStorage.setItem("theme",e),console.warn("[AUTO-CLEAN] localStorage and sessionStorage cleared (theme preserved).")}catch(e){console.warn("[AUTO-CLEAN] Failed to clear storage",e)}try{localStorage.setItem(a,"1")}catch{}try{console.error("[AUTO-CLEAN] CLEANUP COMPLETE. FORCING RELOAD FROM SERVER."),window.location.reload(!0)}catch{window.location.replace(window.location.href)}}catch(a){console.warn("[AUTO-CLEAN] Unexpected error",a)}}ct().catch(()=>{});Re.createRoot(document.getElementById("root")).render(n.jsx(Ce.StrictMode,{children:n.jsx(lt,{})}));
