...
import{r as p,j as n,C as K,_ as pe,B as Ne,S as Ee,M as Te,R as Re,a as De}from"./vendor-react-BMF5l2ym.js";import{B as Me,p as je}from"./vendor-utils-DahDrsZr.js";import{r as Ce}from"./vendor-katex-CiiTTpw-.js";import"./vendor-B3CQIlJd.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const d of o)if(d.type==="childList")for(const r of d.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(o){const d={};return o.integrity&&(d.integrity=o.integrity),o.referrerPolicy&&(d.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?d.credentials="include":o.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function i(o){if(o.ep)return;o.ep=!0;const d=t(o);fetch(o.href,d)}})();function Be({chapters:a,currentChapter:e,bodyContent:t,onChapterSelect:i,currentScript:o,onScriptSelect:d,selectedTopicId:r,onTopicSelect:f,loading:v}){var w,b;const l=p.useMemo(()=>{const s=e==null?void 0:e.content;if(!s)return[];let m="";const _=s.intro;typeof _=="string"?m=_:_&&typeof _=="object"&&_.body&&(m+=typeof _.body=="string"?_.body:Object.values(_.body).join(`
`));const y=t||s.body;if(y&&(typeof y=="string"?m+=`
`+y:Array.isArray(y)?m+=`
`+y.join(`
`):typeof y=="object"&&(m+=`
`+Object.values(y).join(`
`))),!m)return[];const N=/^###\s+(.+)$/gm,D=[];let B;for(;(B=N.exec(m))!==null;){const j=B[1].trim(),A="topic-"+j.replace(/\s+/g,"-").toLowerCase();D.push({id:A,title:j})}return D},[e,t]);return n.jsxs("div",{className:"top-nav-container",children:[n.jsx("div",{className:"nav-group",children:n.jsxs("div",{className:"custom-select-wrapper",children:[n.jsxs("select",{id:"chapter-select",name:"chapter-select",value:(e==null?void 0:e.id)||"",onChange:s=>{const m=a.find(_=>_.id===s.target.value);m&&i(m)},disabled:v||a.length===0,className:"custom-select",children:[n.jsx("option",{value:"",disabled:!0,children:v?"載入中...":"📖 章節選擇"}),a.map(s=>n.jsx("option",{value:s.id,children:s.title},s.id))]}),n.jsx(K,{className:"select-icon",size:16})]})}),n.jsx("div",{className:`nav-group ${!e||l.length===0?"disabled":""}`,children:n.jsxs("div",{className:"custom-select-wrapper",children:[n.jsxs("select",{id:"topic-select",name:"topic-select",value:r,onChange:s=>f(s.target.value),disabled:!e||l.length===0,className:"custom-select",children:[n.jsx("option",{value:"",children:"💡 重點導覽"}),l.map(s=>n.jsx("option",{value:s.id,children:s.title},s.id))]}),n.jsx(K,{className:"select-icon",size:16})]})}),n.jsx("div",{className:`nav-group ${e?"":"disabled"}`,children:n.jsxs("div",{className:"custom-select-wrapper",children:[n.jsxs("select",{id:"script-select",name:"script-select",value:(o==null?void 0:o.filename)||"",onChange:s=>{var _;const m=(e==null?void 0:e.examples)||((_=e==null?void 0:e.content)==null?void 0:_.examples);if(m){const y=m.find(N=>N.filename===s.target.value);y&&d(y)}},disabled:!e||!(e.examples||(w=e.content)!=null&&w.examples)||(e.examples||((b=e.content)==null?void 0:b.examples)||[]).length===0,className:"custom-select",children:[n.jsx("option",{value:"",disabled:!0,children:"💻 程式代碼"}),(()=>{var _;return[...(e==null?void 0:e.examples)||((_=e==null?void 0:e.content)==null?void 0:_.examples)||[]].sort((y,N)=>y.filename.localeCompare(N.filename,void 0,{numeric:!0,sensitivity:"base"})).map(y=>n.jsx("option",{value:y.filename,children:y.filename},y.filename))})()]}),n.jsx(K,{className:"select-icon",size:16})]})})]})}const $e=new Me,Ie=p.memo(({chapter:a,bodyContent:e,onCodeClick:t,selectedTopicId:i,output:o,isRunning:d,plotImages:r})=>{const f=p.useRef(null),v=p.useMemo(()=>{var w,b;if(!a)return null;const l=(w=a.content)==null?void 0:w.intro;if(l){let s="";if(typeof l=="string")s=l;else if(typeof l=="object"){s=`# ${l.title||""}
...
`));const x=e||((b=a.content)==null?void 0:b.body)||l.body;if(x)if(s+=`
...
`);const m=[];s=s.replace(/\$\$([\s\S]*?)\$\$/g,(x,h)=>{const E=m.length;return m.push({type:"display",content:h}),` @@MATH_BLOCK_${E}@@ `}),s=s.replace(/\\begin\{aligned\}([\s\S]*?)\\end\{aligned\}/g,(x,h)=>{const E=m.length;return m.push({type:"display",content:`\\begin{aligned}${h}\\end{aligned}`}),` @@MATH_BLOCK_${E}@@ `}),s=s.replace(new RegExp("(?<!\\\\)\\$([^$\\n]+?)\\$","g"),(x,h)=>{const E=m.length;return m.push({type:"inline",content:h}),` @@MATH_BLOCK_${E}@@ `});let y=$e.parse(s).replace(/<h3>(.*?)<\/h3>/g,(x,h)=>`<h3 id="${"topic-"+h.replace(/<[^>]*>/g,"").trim().replace(/\s+/g,"-").toLowerCase()}">${h}</h3>`);const N=je.sanitize(y,{USE_PROFILES:{html:!0,mathml:!0},ADD_TAGS:["math","annotation","semantics","mrow","msub","msup","msubsup","mover","munder","munderover","mmultiscripts","mprec","mnext","mtable","mtr","mtd","mfrac","msqrt","mroot","mstyle","merror","mpadded","mphantom","mfenced","menclose","ms","mglyph","maligngroup","malignmark","maction","svg","path","use","span","div"],ADD_ATTR:["id","target","xlink:href","class","style","aria-hidden","viewBox","d","fill","stroke","stroke-width","data-filename","encoding","display"]}),B=[...a.examples||[]].sort((x,h)=>h.filename.length-x.filename.length);let j=N;return B.forEach(x=>{const h=x.filename.replace(".","\\."),E=new RegExp(`(?<!['".\\w])(${h})(?!['".\\w])`,"g");j=j.replace(E,`<span class="code-link" data-filename="${x.filename}">${x.filename}</span>`)}),j.replace(/@@MATH_BLOCK_(\d+)@@/g,(x,h)=>{const E=m[parseInt(h)];return E.type==="display"?`\\[ ${E.content.trim()} \\]`:`\\( ${E.content.trim()} \\)`})}else{const s=a.examples||[];let m=`
      ...
      `,m}},[a,e]);return p.useEffect(()=>{const l=w=>{if(w.target.classList.contains("code-link")){const b=w.target.dataset.filename;let s=null;a!=null&&a.examples&&(s=a.examples.find(m=>m.filename===b),s&&!s.metadata&&(s.metadata={description:s.title})),s&&t(s)}};return document.addEventListener("click",l),()=>document.removeEventListener("click",l)},[a,t]),p.useEffect(()=>{const l=document.querySelector(".content-scroll");l&&(l.scrollTop=0)},[a]),p.useEffect(()=>{f.current&&v&&Ce(f.current,{delimiters:[{left:"$$",right:"$$",display:!0},{left:"$",right:"$",display:!1},{left:"\\(",right:"\\)",display:!1},{left:"\\[",right:"\\]",display:!0}],throwOnError:!1})},[v]),p.useEffect(()=>{if(i){const l=document.getElementById(i);l&&l.scrollIntoView({behavior:"smooth",block:"start"})}},[i]),p.useEffect(()=>{if(o||r&&r.length>0||d){const l=document.querySelector(".content-scroll");l&&l.scrollTo({top:0,behavior:"instant"})}},[o,r,d]),n.jsx("div",{className:"content-panel",children:n.jsx("div",{className:"content-scroll",children:o||r&&r.length>0||d?n.jsxs("div",{id:"execution-output",className:"execution-output-section",children:[d&&n.jsxs("div",{className:"running-indicator",children:[n.jsx("div",{className:"spinner"}),n.jsx("span",{children:"程式執行中..."})]}),o&&n.jsx("pre",{className:"output-text",children:o}),r&&r.length>0&&n.jsx("div",{className:"output-images",children:r.map((l,w)=>n.jsx("div",{className:"output-image",children:n.jsx("img",{src:l,alt:`Plot ${w+1}`})},w))})]}):v?n.jsx("div",{ref:f,className:"markdown-body",dangerouslySetInnerHTML:{__html:v}}):n.jsx("div",{className:"welcome-screen",children:n.jsxs("div",{className:"welcome-card premium-welcome",children:[n.jsxs("div",{className:"welcome-brand",children:[n.jsx("img",{src:"welcome.jpg",alt:"FRM Python 理論與實戰",className:"welcome-book-img"}),n.jsx("a",{href:"https://deepwisdom.com.tw/product/%e6%89%8b%e8%a1%93%e5%88%80%e8%88%ac%e7%b2%be%e6%ba%96%e7%9a%84frm-%e7%94%a8python%e7%a7%91%e5%ad%b8%e7%ae%a1%e6%8e%a7%e8%b2%a1%e9%87%91%e9%a2%a8%e9%9a%aa%e5%af%a6%e6%88%b0%e7%af%87dm2308/",target:"_blank",rel:"noopener noreferrer",className:"welcome-purchase-btn",children:"[ 本書官網購買連結 ]"})]}),n.jsxs("div",{className:"welcome-content",children:[n.jsxs("h2",{className:"welcome-title",children:["Python 金融風險管理：",n.jsx("br",{}),"數學模型與應用 (實戰篇)"]}),n.jsx("div",{className:"welcome-slogan",children:"☆★☆★【有如手術刀般精準！利用Python幫你管控財金風險！】★☆★☆"}),n.jsxs("div",{className:"welcome-text-scroll",children:[n.jsx("p",{children:"在上一本基礎篇的學習完備，能善用Python程式語言及常用的工具套件之後，接下來就是開始對金融風險進行評估了。"}),n.jsx("p",{children:"本書接續介紹了各種數學模型，包括波動性、隨機過程及相當重要的馬可夫過程、馬丁格爾、隨機漫步、維納過程等，另外也包含蒙地卡羅等數學模型的應用。"}),n.jsx("p",{children:"而統計科學中最常用的回歸，本書也有涉獵。另外包括了二元樹、BSM選擇權、希臘字母，市場風險等，都有最完整的Python程式和數學公式供讀者計算、運用。"}),n.jsx("p",{children:"金融商品龐大且複雜，需要像使用手術刀般精準、細緻地切割每一個細節，畢竟賠錢事事小，沒辦法掌握到大盤的迅速波動與走勢，才是一大損失。"})]})]})]})})})})});function Fe(){return null}function Ae(a={}){const{immediate:e=!1,onNeedRefresh:t,onOfflineReady:i,onRegistered:o,onRegisteredSW:d,onRegisterError:r}=a;let f,v,l;const w=async(s=!0)=>{await v,l==null||l()};async function b(){if("serviceWorker"in navigator){if(f=await pe(async()=>{const{Workbox:s}=await import("./vendor-B3CQIlJd.js").then(m=>m.w);return{Workbox:s}},[]).then(({Workbox:s})=>new s("/pwa_FRM_Book2/sw.js",{scope:"/pwa_FRM_Book2/",type:"classic"})).catch(s=>{r==null||r(s)}),!f)return;l=()=>{f==null||f.messageSkipWaiting()};{let s=!1;const m=()=>{s=!0,f==null||f.addEventListener("controlling",_=>{_.isUpdate&&window.location.reload()}),t==null||t()};f.addEventListener("installed",_=>{typeof _.isUpdate>"u"?typeof _.isExternal<"u"&&_.isExternal?m():!s&&(i==null||i()):_.isUpdate||i==null||i()}),f.addEventListener("waiting",m)}f.register({immediate:e}).then(s=>{d?d("/pwa_FRM_Book2/sw.js",s):o==null||o(s)}).catch(s=>{r==null||r(s)})}}return v=b(),w}function Qe(a={}){const{immediate:e=!0,onNeedRefresh:t,onOfflineReady:i,onRegistered:o,onRegisteredSW:d,onRegisterError:r}=a,[f,v]=p.useState(!1),[l,w]=p.useState(!1),[b]=p.useState(()=>Ae({immediate:e,onOfflineReady(){w(!0),i==null||i()},onNeedRefresh(){v(!0),t==null||t()},onRegistered:o,onRegisteredSW:d,onRegisterError:r}));return{needRefresh:[f,v],offlineReady:[l,w],updateServiceWorker:b}}function ze(){const{offlineReady:[a,e],needRefresh:[t,i],updateServiceWorker:o}=Qe({onRegisteredSW(r,f){console.debug(`Service Worker at: ${r}`),f&&setInterval(()=>{f.update()},36e5)},onRegisterError(r){console.warn("SW registration error",r)}}),d=()=>{e(!1),i(!1)};return n.jsx("div",{className:"ReloadPrompt-container",children:(a||t)&&n.jsxs("div",{className:"ReloadPrompt-toast",children:[n.jsx("div",{className:"ReloadPrompt-message",children:a?"App ready to work offline":"New content available, click on reload button to update."}),t&&n.jsx("button",{className:"ReloadPrompt-toast-button",onClick:()=>o(!0),children:"Reload"}),n.jsx("button",{className:"ReloadPrompt-toast-button",onClick:d,children:"Close"})]})})}function Oe(a){const[e,t]=p.useState(null),[i,o]=p.useState(!1),d=p.useRef({});return p.useEffect(()=>{if(!a){t(null);return}const r=a.content,f=a.id;if(r!=null&&r.body&&!(r!=null&&r.bodyRef)){t(r.body);return}const v=r==null?void 0:r.bodyRef;if(!v||!Array.isArray(v)||v.length===0){t(null);return}let l=!1;return o(!0),(async()=>{const b={};await Promise.all(v.map(async s=>{const m=`${f}/${s}`;if(d.current[m]!==void 0){b[s]=d.current[m];return}try{const _=`/pwa_FRM_Book2/data/modular/${f}/${s}.json`,y=await fetch(_);if(!y.ok)throw new Error(`HTTP ${y.status}`);const D=(await y.json()).content||"";d.current[m]=D,b[s]=D}catch(_){console.warn(`[useBodyContent] Failed to load ${f}/${s}:`,_),b[s]=""}})),l||(t(b),o(!1))})(),()=>{l=!0}},[a]),{bodyContent:e,bodyLoading:i}}const He=`
# QuantLib (ql) 強大模擬層
...
builtins.input = custom_input
            `),await e.yieldToUI();const d=async(r,f,{timeoutMs:v=15e3,required:l=!1}={})=>{try{await he(t,r,v)}catch(w){if(console.warn(`[Pyodide] Shim failed: ${f}`,w),l)throw w}await e.yieldToUI()};return await d(Ve,"BASE_ENV_SETUP",{timeoutMs:2e4,required:!0}),e.update(92,"核心：正在注入資料集路徑重導向..."),await d(Ke,"DATASET_SHIM",{timeoutMs:15e3,required:!0}),e.update(94,"核心：正在注入常用模組 stub..."),await d(Ge,"SCIPY_STUB",{timeoutMs:15e3}),await d(Ye,"ARCH_STUB",{timeoutMs:15e3}),await d(Je,"MIBIAN_STUB",{timeoutMs:15e3}),await d(_e,"MCINT_SHIM",{timeoutMs:15e3}),await d(ue,"QPSOLVERS_SHIM",{timeoutMs:15e3}),Y=t,I=null,e.finish("基礎核心載入完成！"),t}catch(t){throw I=null,e.interval&&clearInterval(e.interval),console.error("Failed to load Pyodide:",t),t}})(),I)}let oe=!1,z=null;async function at(a){return oe||z||(z=(async()=>{try{const e=["scipy","statsmodels","scikit-learn"];for(const o of e)await a.loadPackage(o);const t=["seaborn","numpy-financial","pandas-datareader","pyodide-http","chart_studio","plotly","prettytable","qpsolvers","tabulate"],i=a.pyimport("micropip");for(const o of t)try{await i.install(o)}catch(d){console.warn(`[Background] Failed to preload ${o}:`,d)}await Promise.all([a.runPythonAsync(We),a.runPythonAsync(Ue),a.runPythonAsync(me),a.runPythonAsync(_e),a.runPythonAsync(ue)]),oe=!0}catch(e){console.error("⚠️ [Background] Heavy package preload failed:",e),z=null}})()),z}async function he(a,e,t=3e4){let i;const o=new Promise((d,r)=>{i=setTimeout(()=>{r(new Error(`Execution timed out after ${t/1e3} seconds`))},t)});try{return await Promise.race([a.runPythonAsync(e),o])}finally{clearTimeout(i)}}async function st(a){if(a)try{await a.runPythonAsync(`
import gc
import matplotlib.pyplot as plt
plt.close('all')
gc.collect()
...
if len(plt.get_fignums()) > 0:
    plt.show()
    `)}catch(e){console.error("Failed to show plots:",e)}}function de(a){const e=a.message||String(a),t=[{pattern:/NameError: name '(.+)' is not defined/,format:i=>`❌ 變數錯誤：'${i[1]}' 未定義`},{pattern:/ModuleNotFoundError: No module named '(.+)'/,format:i=>`❌ 模組錯誤：找不到模組 '${i[1]}'`},{pattern:/SyntaxError/,format:()=>"❌ 語法錯誤"},{pattern:/IndentationError/,format:()=>"❌ 縮排錯誤"},{pattern:/TypeError: (.+)/,format:i=>`❌ 型別錯誤：${i[1]}`},{pattern:/IndexError: (.+)/,format:i=>`❌ 索引錯誤：${i[1]}`},{pattern:/KeyError: (.+)/,format:i=>`❌ 鍵值錯誤：${i[1]}`},{pattern:/ValueError: (.+)/,format:i=>`❌ 數值錯誤：${i[1]}`},{pattern:/ZeroDivisionError/,format:()=>"❌ 除以零錯誤"},{pattern:/ImportError:?\s*(.*)/,format:i=>`❌ 匯入錯誤${i[1]?"："+i[1].trim():""}`}];for(const{pattern:i,format:o}of t){const d=e.match(i);if(d)return o(d)}return`❌ 執行錯誤

${e}`}class it{constructor(){this.metrics={},this.enabled=!0}start(e){this.enabled&&(this.metrics[e]={start:performance.now(),end:null,duration:null})}end(e){if(!this.enabled||!this.metrics[e])return 0;const t=performance.now(),i=this.metrics[e].start,o=t-i;return this.metrics[e].end=t,this.metrics[e].duration=o,this.log(e,o),o}log(e,t){const i=t<100?"⚡":t<1e3?"⏱️":"🐌",o=t<100?"color: green":t<1e3?"color: orange":"color: red";console.debug(`%c${i} ${e}: ${t.toFixed(2)}ms`,o),t>3e3&&console.warn(`⚠️ ${e} 執行時間過長: ${t.toFixed(2)}ms`)}async measure(e,t){this.start(e);try{return await t()}finally{this.end(e)}}getMetric(e){return this.metrics[e]||null}getMetrics(){return{...this.metrics}}getStats(){const e=Object.values(this.metrics).filter(t=>t.duration!==null).map(t=>t.duration);return e.length===0?{count:0,total:0,average:0,min:0,max:0}:{count:e.length,total:e.reduce((t,i)=>t+i,0),average:e.reduce((t,i)=>t+i,0)/e.length,min:Math.min(...e),max:Math.max(...e)}}clear(e){e?delete this.metrics[e]:this.metrics={}}setEnabled(e){this.enabled=e}report(){const e=this.getStats();console.group("📊 效能報告"),console.warn(`總計測量: ${e.count} 次`),console.warn(`總時間: ${e.total.toFixed(2)}ms`),console.warn(`平均時間: ${e.average.toFixed(2)}ms`),console.warn(`最快: ${e.min.toFixed(2)}ms`),console.warn(`最慢: ${e.max.toFixed(2)}ms`),console.groupEnd(),console.group("📋 詳細指標"),Object.entries(this.metrics).forEach(([t,i])=>{i.duration!==null&&console.warn(`${t}: ${i.duration.toFixed(2)}ms`)}),console.groupEnd()}}const F=new it;F.setEnabled(!1);let ce=!1;function ot(){if(!ce&&F.enabled&&(ce=!0,"PerformanceObserver"in window)){new PerformanceObserver(o=>{const d=o.getEntries(),r=d[d.length-1];console.debug("🎨 LCP:",r.renderTime||r.loadTime)}).observe({entryTypes:["largest-contentful-paint"]}),new PerformanceObserver(o=>{o.getEntries().forEach(r=>{console.debug("⚡ FID:",r.processingStart-r.startTime)})}).observe({entryTypes:["first-input"]});let t=0;new PerformanceObserver(o=>{o.getEntries().forEach(r=>{r.hadRecentInput||(t+=r.value)}),console.debug("📐 CLS:",t)}).observe({entryTypes:["layout-shift"]})}}const lt=p.lazy(()=>pe(()=>import("./CodePreviewPanel-BWcJgivw.js"),__vite__mapDeps([0,1,2,3]))),J={QuantLib:"QuantLib",arch:"arch",autograd:"autograd",chart_studio:"chart-studio",datetime:"datetime",lxml:"lxml",math:"math",matplotlib:"matplotlib",mcint:"mcint",mibian:"mibian",mpl_toolkits:"matplotlib",numpy:"numpy",numpy_financial:"wheels/numpy_financial-1.0.0-py3-none-any.whl",openpyxl:"openpyxl",pandas:"pandas",pandas_datareader:"wheels/pandas_datareader-0.10.0-py3-none-any.whl",plotly:"plotly",prettytable:"prettytable",pylab:"matplotlib",pymoo:"wheels/pymoo-0.4.1-py3-none-any.whl",pyodide_http:"wheels/pyodide_http-0.2.2-py3-none-any.whl",qpsolvers:"qpsolvers",requests:"requests","scikit-learn":"scikit-learn",scipy:"scipy",seaborn:"wheels/seaborn-0.13.2-py3-none-any.whl",sklearn:"scikit-learn",statsmodels:"statsmodels",sympy:"sympy",tabulate:"tabulate"},fe={requests:["certifi","charset_normalizer","idna","urllib3"],certifi:"wheels/certifi-2026.1.4-py3-none-any.whl",charset_normalizer:"wheels/charset_normalizer-3.4.4-py3-none-any.whl",idna:"wheels/idna-3.11-py3-none-any.whl",urllib3:"wheels/urllib3-2.6.3-py3-none-any.whl"};typeof window<"u"&&"serviceWorker"in navigator&&(async()=>{try{const a=`/pwa_FRM_Book2/assets-manifest.json?t=${Date.now()}`,e=`/pwa_FRM_Book2/manifest.webmanifest?t=${Date.now()}`;let t=null;try{const r=await fetch(a,{cache:"no-store"});r&&r.ok&&(t=await r.text())}catch{}if(!t)try{const r=await fetch(e,{cache:"no-store"});if(!r||!r.ok)return;t=await r.text()}catch{return}const i=localStorage.getItem("app_assets_manifest_text");if(i&&i===t)return;localStorage.setItem("app_assets_manifest_text",t);const o=await navigator.serviceWorker.getRegistrations();if(!o||o.length===0){localStorage.getItem("app_manifest_reload_done")||(localStorage.setItem("app_manifest_reload_done","1"),location.reload());return}for(const r of o)try{await r.update(),r.waiting&&r.waiting.postMessage({type:"SKIP_WAITING"})}catch(f){console.warn("SW update attempt failed:",f)}const d=()=>{localStorage.getItem("app_manifest_reload_done")||(localStorage.setItem("app_manifest_reload_done","1"),window.location.reload())};navigator.serviceWorker.addEventListener("controllerchange",d)}catch(a){console.warn("Version check/update failed:",a)}})();function dt(){const[a,e]=p.useState(null),[t,i]=p.useState(!0),[o,d]=p.useState(0),[r,f]=p.useState("初始化中..."),[v,l]=p.useState([]),[w,b]=p.useState(!0),[s,m]=p.useState(null),[_,y]=p.useState(null),[N,D]=p.useState(""),[B,j]=p.useState({}),{bodyContent:A}=Oe(s),[x,h]=p.useState(""),[E,C]=p.useState([]),[U,W]=p.useState(!1),[X,ge]=p.useState(!1),[M,ye]=p.useState(()=>{const u=localStorage.getItem("theme");return u==="dark"||!u&&!1}),[Z,ve]=p.useState(600),[$]=p.useState(new Set),[ee,te]=p.useState(null),ae=p.useRef(!1);p.useEffect(()=>{b(!0);const u=`/pwa_FRM_Book2/data/chapters_index.json?t=${Date.now()}`;fetch(u).then(c=>c.json()).then(c=>{c&&c.length>0&&l(c),b(!1)}).catch(c=>{console.error("Failed to load chapters index:",c),b(!1)})},[]);const be=async u=>{if(B[u])return B[u];try{b(!0);const c=await fetch(`/pwa_FRM_Book2/data/chapters_${u}.json?t=${Date.now()}`);if(!c.ok)throw new Error(`HTTP error! status: ${c.status}`);const S=await c.text();let P=null;try{P=JSON.parse(S)}catch{try{const q=S.replace(/\\(?!["\\/bfnrtu])/g,"\\\\");P=JSON.parse(q)}catch(q){throw new Error(`Failed to parse chapter data: ${q.message}`)}}return j(q=>({...q,[u]:P})),b(!1),P}catch(c){return console.error(`Failed to load chapter ${u}:`,c),b(!1),null}};p.useEffect(()=>{tt((c,S)=>{d(c),f(S)}).then(c=>{e(c),i(!1),F.end("pyodide-init")}),ot();const u=[];if("serviceWorker"in navigator){const c=setInterval(()=>{navigator.serviceWorker.getRegistrations().then(P=>{P.forEach(q=>q.update())})},36e5),S=()=>{};navigator.serviceWorker.addEventListener("controllerchange",S),u.push(()=>{clearInterval(c),navigator.serviceWorker.removeEventListener("controllerchange",S)})}if("storage"in navigator&&"estimate"in navigator.storage){const c=async()=>{try{const P=await navigator.storage.estimate();P.usage&&P.quota&&P.usage/P.quota*100>80&&console.warn("Storage usage is high (>80%). Consider cleaning up.")}catch(P){console.warn("Failed to check storage quota:",P)}};c();const S=setInterval(c,300*1e3);u.push(()=>clearInterval(S))}return()=>{u.forEach(c=>c())}},[]),p.useEffect(()=>{a&&!t&&at(a).then(()=>{ae.current||(ae.current=!0,console.warn("Background initialization complete"))}).catch(u=>console.error("Background loaded failed",u))},[a,t]),p.useEffect(()=>{localStorage.setItem("theme",M?"dark":"light"),document.documentElement.setAttribute("data-theme",M?"dark":"light")},[M]);const se=async(u,c=!1)=>{var ne;if(!a)return;const S=u.match(/^\s*(?:from|import)\s+([a-zA-Z0-9_]+)/gm);if(!S)return;if(/^\s*(?:from|import)\s+QuantLib\b/m.test(u)&&!$.has("QuantLib"))try{c||h(g=>g+`正在啟用 QuantLib 相容性墊片...
`),await a.runPythonAsync(He),$.add("QuantLib"),c||h(g=>g+`✅ QuantLib 墊片已啟用。
`)}catch(g){console.warn("QuantLib shim injection failed:",g),c||h(k=>k+`⚠️ QuantLib 墊片啟用失敗，將嘗試繼續執行...
`)}const P=["sys","os","io","time","timeit","base64","json","datetime","math","re","warnings","builtins","types","random","csv","copy","collections","itertools","functools","pathlib","fractions","struct","operator","string","decimal","abc","enum","typing","textwrap"],q=["numpy","pandas","matplotlib","micropip","js","builtins","QuantLib","mcint","arch","mibian"],R=[...new Set(S.map(g=>{const k=g.trim().split(/\s+/);return k[0]==="from",k[1].split(".")[0]}))].filter(g=>!P.includes(g)&&!q.includes(g)).filter(g=>{var k;return!$.has(g)&&!((k=window.failedPackages)!=null&&k.has(g))});if(R.length===0)return;const Q=[],O=[],G=new URL("/pwa_FRM_Book2/",window.location.origin).href,Le=new Set(["scipy","statsmodels","scikit-learn","sympy"]),H=g=>{if(g){if(typeof g=="string"&&(g.endsWith(".whl")||g.startsWith("http"))){O.push(g);return}Le.has(g)?Q.push(g):O.push(g)}},re={sklearn:["scipy","scikit-learn"],"scikit-learn":["scipy"],statsmodels:["scipy"],sympy:[],seaborn:["matplotlib","pandas","scipy","statsmodels"],pandas_datareader:["requests"]};if(R.forEach(g=>{const k=J[g];k?(H(k.endsWith(".whl")?G+k:k),(fe[g]||[]).forEach(T=>{const V=fe[T]||T;H(V.endsWith(".whl")?G+V:V)})):H(g),re[g]&&re[g].forEach(L=>{if(!$.has(L)&&!q.includes(L)){const T=J[L]||L;H(T.endsWith(".whl")?G+T:T)}})}),Q.length>0||O.length>0)try{const g=[...new Set(Q)],k=[...new Set(O)];c||h(L=>L+`正在動態載入所需套件 [${R.join(", ")}]...
...
await micropip.install(${JSON.stringify(k)}, keep_going=True)
        `)),R.includes("pandas_datareader")&&await a.runPythonAsync(me),R.includes("matplotlib")&&(await le(a),ee||te("AGG")),R.forEach(L=>{$.add(L);const T=J[L];T&&!T.endsWith(".whl")&&$.add(T)}),c||h(L=>L+`✅ 套件載入完成。
`)}catch(g){if(console.warn("Dependency loading failed:",g),window.failedPackages||(window.failedPackages=new Set),R.forEach(k=>window.failedPackages.add(k)),!c){const k=g.message||String(g);if(k.includes("Can't find a pure Python 3 wheel")){const L=((ne=k.match(/for: '([^']+)'/))==null?void 0:ne[1])||"unknown";h(T=>T+`⚠️ 套件 "${L}" 無法載入（可能不支援瀏覽器環境），嘗試繼續執行...
`)}else h(L=>L+`⚠️ 套件載入出現問題，嘗試直接執行...
`)}}},we=async u=>{if(!(!a||U||!u)){W(!0),h(`執行中...
`),C([]);try{try{u=u.replace(/pd\.read_csv\(r?['"][^'"]*SPX_Option\.csv['"]\)/g,"pd.read_csv('/data/datasets/b2_ch1/SPX_Option.csv')")}catch{}s&&s.id&&await ie(a,s.id),await se(u),F.start("run-code"),await st(a);const c=u.includes("matplotlib.widgets")||u.includes("Slider")||u.includes("Button");ge(c);const S=c?"module://matplotlib_pyodide.wasm_backend":"AGG";if(ee!==S&&(await le(a,c),te(S)),await a.runPythonAsync(`
import sys
from io import StringIO
sys.stdout = StringIO()
      `),c){const q=document.getElementById("pyodide-plot-container");q&&(q.innerHTML="",window.document.pyodideMplTarget=q)}try{await he(a,u)}catch(q){const R=await a.runPythonAsync("sys.stdout.getvalue()"),Q=de(q);h((R?R+`
`:"")+Q),W(!1),F.end("run-code");return}const P=await a.runPythonAsync("sys.stdout.getvalue()");if(h(P||"執行完成（無文字內容輸出 ）"),X)await nt(a);else{const q=await rt(a);C(q)}}catch(c){const S=de(c);h(S),console.error(c)}finally{W(!1),F.end("run-code")}}},xe=async u=>{let c=u;if(u&&!u.content&&(c=await be(u.id)),!!c&&(m(c),y(null),D(""),h(""),C([]),c&&c.examples&&a)){const S=c.examples.map(P=>P.code).join(`
`);se(S,!0)}};p.useEffect(()=>{a&&s&&s.id&&ie(a,s.id).catch(u=>console.error("Dataset lazy load failed",u))},[a,s]);const ke=u=>{y(u),h(""),C([])},Se=u=>{y(u),h(""),C([])},Pe=()=>{y(null),h(""),C([])},qe=t;return n.jsxs("div",{className:`app ${M?"dark":""}`,children:[n.jsxs("div",{className:"main-content",children:[n.jsxs("div",{className:"top-bar",children:[n.jsxs("div",{className:"top-bar-left",children:[n.jsx(Ne,{size:20,className:"logo-icon"}),n.jsx("span",{className:"app-title",children:"FRM_Book2 (實戰篇)"})]}),n.jsx(Be,{chapters:v,currentChapter:s,bodyContent:A,onChapterSelect:xe,currentScript:_,onScriptSelect:Se,selectedTopicId:N,onTopicSelect:D,loading:w}),n.jsx("div",{className:"top-bar-right",children:n.jsx("button",{className:"theme-toggle",onClick:()=>ye(!M),title:M?"切換到亮色模式":"切換到暗色模式",children:M?n.jsx(Ee,{size:20}):n.jsx(Te,{size:20})})})]}),qe&&n.jsx("div",{className:"hydration-overlay",children:n.jsxs("div",{className:"hydration-card",children:[n.jsxs("div",{className:"hydration-header",children:[n.jsx("div",{className:"hydration-title",children:"FRM Python 引擎啟動中"}),n.jsx("div",{className:"hydration-subtitle",children:"Financial Risk Management"})]}),n.jsx("div",{className:"hydration-progress-container",children:n.jsx("div",{className:"hydration-progress-bar",style:{width:`${o}%`}})}),n.jsxs("div",{className:"hydration-status",children:[n.jsx("span",{children:r}),n.jsxs("span",{children:[o,"%"]})]})]})}),n.jsxs("div",{className:"panes-container",children:[n.jsx("div",{className:"content-pane",children:n.jsx(Ie,{chapter:s,bodyContent:A,onCodeClick:ke,selectedTopicId:N,darkMode:M,output:x,isRunning:U,plotImages:E,onClearOutput:()=>{h(""),C([])}})}),_&&n.jsx("div",{className:"preview-pane",style:{width:`${Z}px`},children:n.jsx(p.Suspense,{fallback:n.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",height:"100%",color:"#888"},children:"Loading Editor..."}),children:n.jsx(lt,{script:_,onClose:Pe,onRun:we,isRunning:U,isLoading:t,output:x,images:E,isInteractive:X,darkMode:M,width:Z,onResize:ve})})})]})]}),n.jsx(Fe,{pyodide:a}),n.jsx(ze,{})]})}Re.createRoot(document.getElementById("root")).render(n.jsx(De.StrictMode,{children:n.jsx(dt,{})}));
