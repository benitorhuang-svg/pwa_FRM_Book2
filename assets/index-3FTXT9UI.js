...
import{r as m,j as n,C as K,_ as pe,B as Te,S as Ne,M as Ee,R as Me,a as Re}from"./vendor-react-BMF5l2ym.js";import{B as De,p as je}from"./vendor-utils-DahDrsZr.js";import{r as Ce}from"./vendor-katex-CiiTTpw-.js";import"./vendor-B3CQIlJd.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const d of o)if(d.type==="childList")for(const r of d.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(o){const d={};return o.integrity&&(d.integrity=o.integrity),o.referrerPolicy&&(d.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?d.credentials="include":o.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function i(o){if(o.ep)return;o.ep=!0;const d=t(o);fetch(o.href,d)}})();function Be({chapters:s,currentChapter:e,bodyContent:t,onChapterSelect:i,currentScript:o,onScriptSelect:d,selectedTopicId:r,onTopicSelect:f,loading:v}){var b,w;const l=m.useMemo(()=>{const a=e==null?void 0:e.content;if(!a)return[];let p="";const _=a.intro;typeof _=="string"?p=_:_&&typeof _=="object"&&_.body&&(p+=typeof _.body=="string"?_.body:Object.values(_.body).join(`
`));const y=t||a.body;if(y&&(typeof y=="string"?p+=`
`+y:Array.isArray(y)?p+=`
`+y.join(`
`):typeof y=="object"&&(p+=`
`+Object.values(y).join(`
`))),!p)return[];const E=/^###\s+(.+)$/gm,j=[];let $;for(;($=E.exec(p))!==null;){const B=$[1].trim(),z="topic-"+B.replace(/\s+/g,"-").toLowerCase();j.push({id:z,title:B})}return j},[e,t]);return n.jsxs("div",{className:"top-nav-container",children:[n.jsx("div",{className:"nav-group",children:n.jsxs("div",{className:"custom-select-wrapper",children:[n.jsxs("select",{id:"chapter-select",name:"chapter-select",value:(e==null?void 0:e.id)||"",onChange:a=>{const p=s.find(_=>_.id===a.target.value);p&&i(p)},disabled:v||s.length===0,className:"custom-select",children:[n.jsx("option",{value:"",disabled:!0,children:v?"載入中...":"📖 章節選擇"}),s.map(a=>n.jsx("option",{value:a.id,children:a.title},a.id))]}),n.jsx(K,{className:"select-icon",size:16})]})}),n.jsx("div",{className:`nav-group ${!e||l.length===0?"disabled":""}`,children:n.jsxs("div",{className:"custom-select-wrapper",children:[n.jsxs("select",{id:"topic-select",name:"topic-select",value:r,onChange:a=>f(a.target.value),disabled:!e||l.length===0,className:"custom-select",children:[n.jsx("option",{value:"",children:"💡 重點導覽"}),l.map(a=>n.jsx("option",{value:a.id,children:a.title},a.id))]}),n.jsx(K,{className:"select-icon",size:16})]})}),n.jsx("div",{className:`nav-group ${e?"":"disabled"}`,children:n.jsxs("div",{className:"custom-select-wrapper",children:[n.jsxs("select",{id:"script-select",name:"script-select",value:(o==null?void 0:o.filename)||"",onChange:a=>{var _;const p=(e==null?void 0:e.examples)||((_=e==null?void 0:e.content)==null?void 0:_.examples);if(p){const y=p.find(E=>E.filename===a.target.value);y&&d(y)}},disabled:!e||!(e.examples||(b=e.content)!=null&&b.examples)||(e.examples||((w=e.content)==null?void 0:w.examples)||[]).length===0,className:"custom-select",children:[n.jsx("option",{value:"",disabled:!0,children:"💻 程式代碼"}),(()=>{var _;return[...(e==null?void 0:e.examples)||((_=e==null?void 0:e.content)==null?void 0:_.examples)||[]].sort((y,E)=>y.filename.localeCompare(E.filename,void 0,{numeric:!0,sensitivity:"base"})).map(y=>n.jsx("option",{value:y.filename,children:y.filename},y.filename))})()]}),n.jsx(K,{className:"select-icon",size:16})]})})]})}const $e=new De,Ae=m.memo(({chapter:s,bodyContent:e,onCodeClick:t,selectedTopicId:i,output:o,isRunning:d,plotImages:r})=>{const f=m.useRef(null),v=m.useMemo(()=>{var b,w;if(!s)return null;const l=(b=s.content)==null?void 0:b.intro;if(l){let a="";if(typeof l=="string")a=l;else if(typeof l=="object"){a=`# ${l.title||""}
...
`));const g=e||((w=s.content)==null?void 0:w.body)||l.body;if(g)if(a+=`
...
`);const p=[];a=a.replace(/\$\$([\s\S]*?)\$\$/g,(g,x)=>{const k=p.length;return p.push({type:"display",content:x}),` @@MATH_BLOCK_${k}@@ `}),a=a.replace(/\\\[([\s\S]*?)\\\]/g,(g,x)=>{const k=p.length;return p.push({type:"display",content:x}),` @@MATH_BLOCK_${k}@@ `}),a=a.replace(/\\begin\{aligned\}([\s\S]*?)\\end\{aligned\}/g,(g,x)=>{const k=p.length;return p.push({type:"display",content:`\\begin{aligned}${x}\\end{aligned}`}),` @@MATH_BLOCK_${k}@@ `}),a=a.replace(new RegExp("(?<!\\\\)\\$([^$\\n]+?)\\$","g"),(g,x)=>{const k=p.length;return p.push({type:"inline",content:x}),` @@MATH_BLOCK_${k}@@ `}),a=a.replace(/\\\(([\s\S]*?)\\\)/g,(g,x)=>{const k=p.length;return p.push({type:"inline",content:x}),` @@MATH_BLOCK_${k}@@ `}),a=a.replace(/^[ \t]+(?=<)/gm,"");let y=$e.parse(a).replace(/<h3>(.*?)<\/h3>/g,(g,x)=>`<h3 id="${"topic-"+x.replace(/<[^>]*>/g,"").trim().replace(/\s+/g,"-").toLowerCase()}">${x}</h3>`);const E=je.sanitize(y,{USE_PROFILES:{html:!0,mathml:!0,svg:!0},ADD_TAGS:["math","annotation","semantics","mrow","msub","msup","msubsup","mover","munder","munderover","mmultiscripts","mprec","mnext","mtable","mtr","mtd","mfrac","msqrt","mroot","mstyle","merror","mpadded","mphantom","mfenced","menclose","ms","mglyph","maligngroup","malignmark","maction","svg","path","use","span","div","g","text","rect","circle","line","polyline","polygon","defs","marker","symbol"],ADD_ATTR:["id","target","xlink:href","class","style","aria-hidden","viewBox","d","fill","stroke","stroke-width","data-filename","encoding","display","x","y","cx","cy","r","width","height","text-anchor","font-size","font-family","font-weight","transform","marker-end","refX","refY","orient","stroke-dasharray","fill-opacity"]}),$=[...s.examples||[]].sort((g,x)=>x.filename.length-g.filename.length);let B=E;$.forEach(g=>{const x=g.filename.replace(".","\\."),k=new RegExp(`(?<!['".\\w])(${x})(?!['".\\w])`,"g");B=B.replace(k,`<span class="code-link" data-filename="${g.filename}">${g.filename}</span>`)});let M=B.replace(/@@MATH_BLOCK_(\d+)@@/g,(g,x)=>{const k=p[parseInt(x)];try{return katex.renderToString(k.content.trim(),{displayMode:k.type==="display",throwOnError:!1})}catch(A){return console.error("[KaTeX] Error rendering block:",A),k.type==="display"?`\\[ ${k.content} \\]`:`\\( ${k.content} \\)`}});const S={long_call:`
          ...
          </div>`};return M=M.replace(/<strong>1\. 買入看漲選擇權 \(Long Call\)<\/strong>/g,g=>g+S.long_call),M=M.replace(/<strong>2\. 賣出看漲選擇權 \(Short Call\)<\/strong>/g,g=>g+S.short_call),M=M.replace(/<strong>3\. 買入看跌選擇權 \(Long Put\)<\/strong>/g,g=>g+S.long_put),M=M.replace(/<strong>4\. 賣出看跌選擇權 \(Short Put\)<\/strong>/g,g=>g+S.short_put),M}else{const a=s.examples||[];let p=`
        <div class="chapter-intro">
          <h2>${s.title}</h2>
          <p>本章包含 ${a.length} 個程式範例</p>
          <div class="example-grid">
      `;return a.forEach((_,y)=>{p+=`
      ...
      `,p}},[s,e]);return m.useEffect(()=>{const l=b=>{if(b.target.classList.contains("code-link")){const w=b.target.dataset.filename;let a=null;s!=null&&s.examples&&(a=s.examples.find(p=>p.filename===w),a&&!a.metadata&&(a.metadata={description:a.title})),a&&t(a)}};return document.addEventListener("click",l),()=>document.removeEventListener("click",l)},[s,t]),m.useEffect(()=>{const l=document.querySelector(".content-scroll");l&&(l.scrollTop=0)},[s]),m.useEffect(()=>{f.current&&v&&Ce(f.current,{delimiters:[{left:"$$",right:"$$",display:!0},{left:"$",right:"$",display:!1},{left:"\\(",right:"\\)",display:!1},{left:"\\[",right:"\\]",display:!0}],throwOnError:!1})},[v]),m.useEffect(()=>{if(i){const l=document.getElementById(i);l&&l.scrollIntoView({behavior:"smooth",block:"start"})}},[i]),m.useEffect(()=>{if(o||r&&r.length>0||d){const l=document.querySelector(".content-scroll");l&&l.scrollTo({top:0,behavior:"instant"})}},[o,r,d]),n.jsx("div",{className:"content-panel",children:n.jsx("div",{className:"content-scroll",children:o||r&&r.length>0||d?n.jsxs("div",{id:"execution-output",className:"execution-output-section",children:[d&&n.jsxs("div",{className:"running-indicator",children:[n.jsx("div",{className:"spinner"}),n.jsx("span",{children:"程式執行中..."})]}),o&&n.jsx("pre",{className:"output-text",children:o}),r&&r.length>0&&n.jsx("div",{className:"output-images",children:r.map((l,b)=>n.jsx("div",{className:"output-image",children:n.jsx("img",{src:l,alt:`Plot ${b+1}`})},b))})]}):v?n.jsx("div",{ref:f,className:"markdown-body",dangerouslySetInnerHTML:{__html:v}}):n.jsx("div",{className:"welcome-screen",children:n.jsxs("div",{className:"welcome-card premium-welcome",children:[n.jsxs("div",{className:"welcome-brand",children:[n.jsx("img",{src:"welcome.jpg",alt:"FRM Python 理論與實戰",className:"welcome-book-img"}),n.jsx("a",{href:"https://deepwisdom.com.tw/product/%e6%89%8b%e8%a1%93%e5%88%80%e8%88%ac%e7%b2%be%e6%ba%96%e7%9a%84frm-%e7%94%a8python%e7%a7%91%e5%ad%b8%e7%ae%a1%e6%8e%a7%e8%b2%a1%e9%87%91%e9%a2%a8%e9%9a%aa%e5%af%a6%e6%88%b0%e7%af%87dm2308/",target:"_blank",rel:"noopener noreferrer",className:"welcome-purchase-btn",children:"[ 本書官網購買連結 ]"})]}),n.jsxs("div",{className:"welcome-content",children:[n.jsxs("h2",{className:"welcome-title",children:["Python 金融風險管理：",n.jsx("br",{}),"數學模型與應用 (實戰篇)"]}),n.jsx("div",{className:"welcome-slogan",children:"☆★☆★【有如手術刀般精準！利用Python幫你管控財金風險！】★☆★☆"}),n.jsxs("div",{className:"welcome-text-scroll",children:[n.jsx("p",{children:"在上一本基礎篇的學習完備，能善用Python程式語言及常用的工具套件之後，接下來就是開始對金融風險進行評估了。"}),n.jsx("p",{children:"本書接續介紹了各種數學模型，包括波動性、隨機過程及相當重要的馬可夫過程、馬丁格爾、隨機漫步、維納過程等，另外也包含蒙地卡羅等數學模型的應用。"}),n.jsx("p",{children:"而統計科學中最常用的回歸，本書也有涉獵。另外包括了二元樹、BSM選擇權、希臘字母，市場風險等，都有最完整的Python程式和數學公式供讀者計算、運用。"}),n.jsx("p",{children:"金融商品龐大且複雜，需要像使用手術刀般精準、細緻地切割每一個細節，畢竟賠錢事事小，沒辦法掌握到大盤的迅速波動與走勢，才是一大損失。"})]})]})]})})})})});function Ie(){return null}function Fe(s={}){const{immediate:e=!1,onNeedRefresh:t,onOfflineReady:i,onRegistered:o,onRegisteredSW:d,onRegisterError:r}=s;let f,v,l;const b=async(a=!0)=>{await v,l==null||l()};async function w(){if("serviceWorker"in navigator){if(f=await pe(async()=>{const{Workbox:a}=await import("./vendor-B3CQIlJd.js").then(p=>p.w);return{Workbox:a}},[]).then(({Workbox:a})=>new a("/pwa_FRM_Book2/sw.js",{scope:"/pwa_FRM_Book2/",type:"classic"})).catch(a=>{r==null||r(a)}),!f)return;l=()=>{f==null||f.messageSkipWaiting()};{let a=!1;const p=()=>{a=!0,f==null||f.addEventListener("controlling",_=>{_.isUpdate&&window.location.reload()}),t==null||t()};f.addEventListener("installed",_=>{typeof _.isUpdate>"u"?typeof _.isExternal<"u"&&_.isExternal?p():!a&&(i==null||i()):_.isUpdate||i==null||i()}),f.addEventListener("waiting",p)}f.register({immediate:e}).then(a=>{d?d("/pwa_FRM_Book2/sw.js",a):o==null||o(a)}).catch(a=>{r==null||r(a)})}}return v=w(),b}function Qe(s={}){const{immediate:e=!0,onNeedRefresh:t,onOfflineReady:i,onRegistered:o,onRegisteredSW:d,onRegisterError:r}=s,[f,v]=m.useState(!1),[l,b]=m.useState(!1),[w]=m.useState(()=>Fe({immediate:e,onOfflineReady(){b(!0),i==null||i()},onNeedRefresh(){v(!0),t==null||t()},onRegistered:o,onRegisteredSW:d,onRegisterError:r}));return{needRefresh:[f,v],offlineReady:[l,b],updateServiceWorker:w}}function ze(){const{offlineReady:[s,e],needRefresh:[t,i],updateServiceWorker:o}=Qe({onRegisteredSW(r,f){console.debug(`Service Worker at: ${r}`),f&&setInterval(()=>{f.update()},36e5)},onRegisterError(r){console.warn("SW registration error",r)}}),d=()=>{e(!1),i(!1)};return n.jsx("div",{className:"ReloadPrompt-container",children:(s||t)&&n.jsxs("div",{className:"ReloadPrompt-toast",children:[n.jsx("div",{className:"ReloadPrompt-message",children:s?"App ready to work offline":"New content available, click on reload button to update."}),t&&n.jsx("button",{className:"ReloadPrompt-toast-button",onClick:()=>o(!0),children:"Reload"}),n.jsx("button",{className:"ReloadPrompt-toast-button",onClick:d,children:"Close"})]})})}function Oe(s){const[e,t]=m.useState(null),[i,o]=m.useState(!1),d=m.useRef({});return m.useEffect(()=>{if(!s){t(null);return}const r=s.content,f=s.id;if(r!=null&&r.body&&!(r!=null&&r.bodyRef)){t(r.body);return}const v=r==null?void 0:r.bodyRef;if(!v||!Array.isArray(v)||v.length===0){t(null);return}let l=!1;return o(!0),(async()=>{const w={};await Promise.all(v.map(async a=>{const p=`${f}/${a}`;if(d.current[p]!==void 0){w[a]=d.current[p];return}try{const _=`/pwa_FRM_Book2/data/modular/${f}/${a}.json`,y=await fetch(_);if(!y.ok)throw new Error(`HTTP ${y.status}`);const j=(await y.json()).content||"";d.current[p]=j,w[a]=j}catch(_){console.warn(`[useBodyContent] Failed to load ${f}/${a}:`,_),w[a]=""}})),l||(t(w),o(!1))})(),()=>{l=!0}},[s]),{bodyContent:e,bodyLoading:i}}const He=`
# QuantLib (ql) 強大模擬層
...
await micropip.install(${JSON.stringify(P)}, keep_going=True)
        `)),D.includes("pandas_datareader")&&await s.runPythonAsync(me),D.includes("matplotlib")&&(await le(s),ee||te("AGG")),D.forEach(N=>{I.add(N);const R=X[N];R&&!R.endsWith(".whl")&&I.add(R)}),c||S(N=>N+`✅ 套件載入完成。
`)}catch(h){if(console.warn("Dependency loading failed:",h),window.failedPackages||(window.failedPackages=new Set),D.forEach(P=>window.failedPackages.add(P)),!c){const P=h.message||String(h);if(P.includes("Can't find a pure Python 3 wheel")){const N=((ne=P.match(/for: '([^']+)'/))==null?void 0:ne[1])||"unknown";S(R=>R+`⚠️ 套件 "${N}" 無法載入（可能不支援瀏覽器環境），嘗試繼續執行...
`)}else S(N=>N+`⚠️ 套件載入出現問題，嘗試直接執行...
`)}}},we=async u=>{if(!(!s||k||!u)){A(!0),S(`執行中...
`),x([]);try{try{u=u.replace(/pd\.read_csv\(r?['"][^'"]*SPX_Option\.csv['"]\)/g,"pd.read_csv('/data/datasets/b2_ch1/SPX_Option.csv')")}catch{}a&&a.id&&await ie(s,a.id),await se(u),Q.start("run-code"),await st(s);const c=u.includes("matplotlib.widgets")||u.includes("Slider")||u.includes("Button");ge(c);const L=c?"module://matplotlib_pyodide.wasm_backend":"AGG";if(ee!==L&&(await le(s,c),te(L)),await s.runPythonAsync(`
import sys
from io import StringIO
sys.stdout = StringIO()
      `),c){const T=document.getElementById("pyodide-plot-container");T&&(T.innerHTML="",window.document.pyodideMplTarget=T)}try{await he(s,u)}catch(T){const D=await s.runPythonAsync("sys.stdout.getvalue()"),O=de(T);S((D?D+`
`:"")+O),A(!1),Q.end("run-code");return}const q=await s.runPythonAsync("sys.stdout.getvalue()");if(S(q||"執行完成（無文字內容輸出 ）"),J)await nt(s);else{const T=await rt(s);x(T)}}catch(c){const L=de(c);S(L),console.error(c)}finally{A(!1),Q.end("run-code")}}},be=async u=>{let c=u;if(u&&!u.content&&(c=await xe(u.id)),!!c&&(p(c),y(null),j(""),S(""),x([]),c&&c.examples&&s)){const L=c.examples.map(q=>q.code).join(`
`);se(L,!0)}};m.useEffect(()=>{s&&a&&a.id&&ie(s,a.id).catch(u=>console.error("Dataset lazy load failed",u))},[s,a]);const ke=u=>{y(u),S(""),x([])},Se=u=>{y(u),S(""),x([])},Pe=()=>{y(null),S(""),x([])},Le=t;return n.jsxs("div",{className:`app ${C?"dark":""}`,children:[n.jsxs("div",{className:"main-content",children:[n.jsxs("div",{className:"top-bar",children:[n.jsxs("div",{className:"top-bar-left",children:[n.jsx(Te,{size:20,className:"logo-icon"}),n.jsx("span",{className:"app-title",children:"FRM_Book2 (實戰篇)"})]}),n.jsx(Be,{chapters:v,currentChapter:a,bodyContent:z,onChapterSelect:be,currentScript:_,onScriptSelect:Se,selectedTopicId:E,onTopicSelect:j,loading:b}),n.jsx("div",{className:"top-bar-right",children:n.jsx("button",{className:"theme-toggle",onClick:()=>ye(!C),title:C?"切換到亮色模式":"切換到暗色模式",children:C?n.jsx(Ne,{size:20}):n.jsx(Ee,{size:20})})})]}),Le&&n.jsx("div",{className:"hydration-overlay",children:n.jsxs("div",{className:"hydration-card",children:[n.jsxs("div",{className:"hydration-header",children:[n.jsx("div",{className:"hydration-title",children:"FRM Python 引擎啟動中"}),n.jsx("div",{className:"hydration-subtitle",children:"Financial Risk Management"})]}),n.jsx("div",{className:"hydration-progress-container",children:n.jsx("div",{className:"hydration-progress-bar",style:{width:`${o}%`}})}),n.jsxs("div",{className:"hydration-status",children:[n.jsx("span",{children:r}),n.jsxs("span",{children:[o,"%"]})]})]})}),n.jsxs("div",{className:"panes-container",children:[n.jsx("div",{className:"content-pane",children:n.jsx(Ae,{chapter:a,bodyContent:z,onCodeClick:ke,selectedTopicId:E,darkMode:C,output:M,isRunning:k,plotImages:g,onClearOutput:()=>{S(""),x([])}})}),_&&n.jsx("div",{className:"preview-pane",style:{width:`${Z}px`},children:n.jsx(m.Suspense,{fallback:n.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",height:"100%",color:"#888"},children:"Loading Editor..."}),children:n.jsx(lt,{script:_,onClose:Pe,onRun:we,isRunning:k,isLoading:t,output:M,images:g,isInteractive:J,darkMode:C,width:Z,onResize:ve})})})]})]}),n.jsx(Ie,{pyodide:s}),n.jsx(ze,{})]})}Me.createRoot(document.getElementById("root")).render(n.jsx(Re.StrictMode,{children:n.jsx(dt,{})}));
