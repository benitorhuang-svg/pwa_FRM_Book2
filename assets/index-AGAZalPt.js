...
await micropip.install(${JSON.stringify(k)}, keep_going=True)
        `)),R.includes("pandas_datareader")&&await a.runPythonAsync(me),R.includes("matplotlib")&&(await le(a),ee||te("AGG")),R.forEach(E=>{B.add(E);const T=J[E];T&&!T.endsWith(".whl")&&B.add(T)}),c||h(E=>E+`✅ 套件載入完成。
