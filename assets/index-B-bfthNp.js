...
import{r as p,j as n,C as K,_ as pe,B as qe,S as Ne,M as Te,R as Re,a as Ce}from"./vendor-react-BScQi9YO.js";import{B as Me,p as De}from"./vendor-utils-DahDrsZr.js";import{r as je}from"./vendor-katex-BZbyxtyH.js";import"./vendor-B3CQIlJd.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const c of o)if(c.type==="childList")for(const r of c.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function t(o){const c={};return o.integrity&&(c.integrity=o.integrity),o.referrerPolicy&&(c.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?c.credentials="include":o.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function i(o){if(o.ep)return;o.ep=!0;const c=t(o);fetch(o.href,c)}})();function Ae({chapters:a,currentChapter:e,bodyContent:t,onChapterSelect:i,currentScript:o,onScriptSelect:c,selectedTopicId:r,onTopicSelect:f,loading:v}){var b,w;const l=p.useMemo(()=>{const s=e==null?void 0:e.content;if(!s)return[];let m="";const _=s.intro;typeof _=="string"?m=_:_&&typeof _=="object"&&_.body&&(m+=typeof _.body=="string"?_.body:Object.values(_.body).join(`
