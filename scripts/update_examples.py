...
TARGET_DATA_DIR = r"c:\Users\benit\Desktop\FRM MATLAB\Python\pwa_Book2_python\public\data"
                            ...
                            if source_path and os.path.exists(source_path):
                                try:
                                    ...
                                    if example.get("code") != code_content:
                                        ...
                                        modified = True
                                        examples_updated += 1
                                        print(f"Updated code for {script_filename} in {filename}")
                                    else:
                                        print(f"Code for {script_filename} already up to date.")
